...
/**
 * Generic methods of a remote RDF store
...
public class RDFStore {
    ...
    /**
     * Create a list of anonymous instances for each of the classes given as
     * parameter. The created instances have a label "a "+ label of the class.
     *
     * @param classes
     * @return
     */
